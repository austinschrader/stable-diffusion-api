# -*- coding: utf-8 -*-
"""Deforum_Stable_Diffusion (1).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1xQMQ4ogrEmrCOd1cbzUNv4ck6tGOZFcG
...
sub_p_res = subprocess.run(['nvidia-smi', '--query-gpu=name,memory.total,memory.free', '--format=csv,noheader'],
...
def run(_prompts, _animation_prompt, _max_frames, _animation_mode):
    ...
    def DeforumArgs():
        ...
        grid_rows = 2  # @param
        print(get_output_folder(output_path, batch_name))
    ...
    def render_animation(args, anim_args):
        ...
        args.prompts = _animation_prompt
        ...
        for i, prompt in _animation_prompt.items():
    ...
    image_path = "content/output/2023-01/StableFun/20230118222025_00009.png_%05d.png"  # @param {type:"string"}
    mp4_path = "content/output/2023-01/StableFun/20230118222025_00009.png.mp4"  # @param {type:"string"}
    ...
    if skip_video_for_run_all == True:
        ...
        if use_manual_settings:
            max_frames = _max_frames  # @param {type:"string"}
        else:
